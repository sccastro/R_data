...
#  echo submitting $1.sh
  ...
  ssh ares "set -e ; source /grid/sge6/default/common/settings.sh ; /grid/sge6/bin/lx24-amd64/qsub -R yes -clear -q es409.q -N $1 -o ~/hpc/hydra-tmp/$1-$$.o -e ~/hpc/hydra-tmp/$1-$$.e ~/hpc/hydra-tmp/run.sh ~/hpc/hydra-tmp/$1.sh"
