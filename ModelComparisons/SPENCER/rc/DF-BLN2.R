...
# Outputs standard m, s, ter, pc parameterization by adding columns to
...
dfun=function(t,parlist,cv=NULL) {  
  ...
  n1PDFfixedt0=function(t,mu,sig) {
...
#   n: number samples for each accumulator
  ...
  repeat {
    ...
    rts <- matrix(rlnorm(nacc*onen,pi$m,sqrt(pi$v)),nrow=nacc)
