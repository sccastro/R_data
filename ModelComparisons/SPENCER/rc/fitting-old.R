...
# hydra.max=128;refit=FALSE;report.updates=FALSE; save.fitreport=FALSE
# 
# update.available=TRUE; repeat.fit=10;precision=2
...
hydra.hfits=function(dname,subjects=NA,topmodel=1,max.ntry=20,
  ...
  est.time=60*60*10,nesttol=.1,get.se=F,get.bma=FALSE,
  do.fit=TRUE,parscale=TRUE,update.available=FALSE,
  hydra.max=128,refit=FALSE,report.updates=FALSE,
  ...
  # best.or.start: if best not available replace with start
